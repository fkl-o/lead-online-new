...
// Conditional PWA import for production builds on Render
let VitePWAPlugin;
try {
  const { VitePWA } = await import('vite-plugin-pwa');
  VitePWAPlugin = VitePWA({
  ...
  console.log('PWA plugin not available, continuing without PWA features');
  VitePWAPlugin = undefined;
}
