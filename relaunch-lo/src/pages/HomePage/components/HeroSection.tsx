    ...
    <section className="pt-28 pb-20 md:pt-40 md:pb-32 text-center relative overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <a 
          href="#services" 
          ref={btnRef}
          className="reveal inline-block bg-brand-600 hover:bg-brand-700 text-white font-bold text-lg px-8 py-4 md:px-10 md:py-5 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg shadow-brand-600/20"
        >
