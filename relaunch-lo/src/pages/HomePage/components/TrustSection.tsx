  ...
  return (
    <section id="trust" className="py-20 md:py-28 bg-white">
        <div className="container mx-auto px-6">
            ...
            {/* Kundenlogos */}
            <div ref={logosRef} className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-8 items-center mb-20 reveal">
            ...
            <div ref={testimonialsRef} className="grid lg:grid-cols-3 gap-8 items-start max-w-7xl mx-auto reveal">
