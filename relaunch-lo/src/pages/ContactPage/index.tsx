...
const ContactPage = () => {
	...
	return (
		<section className="pt-28 pb-20 md:pt-40 md:pb-32 relative overflow-hidden bg-white min-h-screen">
			<div className="absolute inset-0 hero-pattern"></div>
			<div className="container mx-auto px-6 relative z-10 flex flex-col items-center">				<h1
					ref={titleRef}
