  ...
  return (
    <section className="pt-28 pb-20 md:pt-40 md:pb-32 text-center relative overflow-hidden bg-white">
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          Ganzheitliche <span className="text-brand-600">Digitalisierung</span> für Ihr Unternehmen
        </h1>
        <p
          ref={descRef}
          className="reveal max-w-3xl mx-auto text-lg md:text-xl text-slate-600 mb-10"
        >
          Von der Prozessoptimierung bis zur IT-Sicherheit: Wir gestalten Ihre digitale Zukunft und steigern Ihre Wettbewerbsfähigkeit.
        </p>
      </div>
    </section>
  );
