...
const benefits = [
  {
    ...
    description: 'Automatisierte Prozesse sparen Zeit und Ressourcen, damit Sie sich auf das Wesentliche konzentrieren können.',
  },
  {
    icon: Users,
    title: 'Bessere Kundenbindung',
    description: 'Personalisierte Kampagnen sorgen für mehr Engagement und Loyalität bei Ihren Kunden.',
  },
  {
    icon: Zap,
    title: 'Multi-Channel-Kommunikation',
    description: 'Sprechen Sie Ihre Zielgruppe über E-Mail, SMS und Social Media automatisiert an.',
  },
  {
    icon: ShieldCheck,
    title: 'Datensicherheit & Compliance',
    description: 'Unsere Lösungen entsprechen den neuesten Datenschutzrichtlinien und schützen Ihre Daten.',
  },
];
      ...
      <div className="container mx-auto px-6">
        <div ref={headingRef} className="text-center max-w-3xl mx-auto mb-20 reveal">
          ...
          <p className="text-slate-600 text-lg md:text-xl">
            Entdecken Sie, wie Marketing Automation Ihr Unternehmen voranbringen kann.
          </p>
        </div>

        <div ref={benefitsRef} className="grid sm:grid-cols-2 lg:grid-cols-2 gap-10 max-w-5xl mx-auto reveal">
          {benefits.map((benefit, index) => (
            <div key={index} className="group relative overflow-hidden bg-white border border-gray-100 rounded-3xl p-10 shadow-sm transition-all duration-300 hover:shadow-xl hover:-translate-y-2">
